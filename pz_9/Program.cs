...
namespace pz_9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int q = 0; // переменная для подсчёта отриц. элементов в конце
                ...
                for (int j = 0; j < 7; j++) // цикл для определения боковой диагонали матрицы
                {
                    if (i == 7 - j - 1) // условие на определение боковой диагонали матрицы
                    {
                        ...
                        if (S[i] < 0) // условие на определение отрицательности
                        {
                            ...
                            q++; // подсчёт отрицательных элементов
                        }
                    }                    
                }
            }
            Console.WriteLine($"\nКоличество отрицательных элементов = {q}");
            // здесь я уже запутался и не понял как разделить и нормально вывести отрицательные элементы от всей побочной диагонали
        }
    }
}
